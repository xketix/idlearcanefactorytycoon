import Feature from "../Components/Media/Feature";
...
const Media = () => {
  return (
    <div
      className="bg-[url('/src/assets/Imgs/Pattern/BG_linear_Mobile.svg')] lg:bg-[url('/src/assets/Imgs/Pattern/BG_linear.svg')]
        bg-no-repeat bg-center bg-top bg-fixed
        px-10 lg:px-50 py-20"
    >
      <div className="flex flex-col gap-10">
        <div className="flex items-start flex-col gap-6">
          <h1 className="text-3xl font-share-tech-mono text-center">
            Features
          </h1>
